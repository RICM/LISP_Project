/* Generated By:JavaCC: Do not edit this line. GrammaireLISPTokenManager.java */
package reader;
import lisp.*;
import exception.*;
import java.io.*;
   ...
   switch(curChar)
   {
      case 42:
         if ((active0 & 0x1000000000L) != 0L)
            return jjStartNfaWithStates_0(1, 36, 0);
         break;
      case 47:
...
/** Constructor. */
public GrammaireLISPTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public GrammaireLISPTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
